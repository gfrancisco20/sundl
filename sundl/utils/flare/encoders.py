...
def mpf_C_metrics_decoder(flux):
  ...
  """
  return tf.cast(mpfDecoder(flux)>=mpfTresh['C'][0], dtype = prec)
...
def mpf_M_metrics_decoder(flux):
  ...
  """
  return tf.cast(mpfDecoder(flux)>=mpfTresh['M'][0], dtype = prec)
...
def mpf_X_metrics_decoder(flux):
  ...
  """
  return tf.cast(mpfDecoder(flux)>=mpfTresh['X'][0], dtype = prec)
...
#   toteh_C_metrics_decoders[window_h] = lambda flux : tf.cast(totehDecoders[window_h](flux)>=totehTresh[window_h]['C'][0], dtype = prec)
#   toteh_M_metrics_decoders[window_h] = lambda flux : tf.cast(totehDecoders[window_h](flux)>=totehTresh[window_h]['M'][0], dtype = prec)
#   toteh_X_metrics_decoders[window_h] = lambda flux : tf.cast(totehDecoders[window_h](flux)>=totehTresh[window_h]['X'][0], dtype = prec)
...
toteh_C_metrics_decoders[2] = lambda flux : tf.cast(totehDecoders[2](flux)>=totehTresh[2]['C'][0], dtype = prec)
toteh_M_metrics_decoders[2] = lambda flux : tf.cast(totehDecoders[2](flux)>=totehTresh[2]['M'][0], dtype = prec)
toteh_X_metrics_decoders[2] = lambda flux : tf.cast(totehDecoders[2](flux)>=totehTresh[2]['X'][0], dtype = prec)
...
toteh_C_metrics_decoders[4] = lambda flux : tf.cast(totehDecoders[4](flux)>=totehTresh[4]['C'][0], dtype = prec)
toteh_M_metrics_decoders[4] = lambda flux : tf.cast(totehDecoders[4](flux)>=totehTresh[4]['M'][0], dtype = prec)
toteh_X_metrics_decoders[4] = lambda flux : tf.cast(totehDecoders[4](flux)>=totehTresh[4]['X'][0], dtype = prec)
...
toteh_C_metrics_decoders[8] = lambda flux : tf.cast(totehDecoders[8](flux)>=totehTresh[8]['C'][0], dtype = prec)
toteh_M_metrics_decoders[8] = lambda flux : tf.cast(totehDecoders[8](flux)>=totehTresh[8]['M'][0], dtype = prec)
toteh_X_metrics_decoders[8] = lambda flux : tf.cast(totehDecoders[8](flux)>=totehTresh[8]['X'][0], dtype = prec)
...
toteh_C_metrics_decoders[12] = lambda flux : tf.cast(totehDecoders[12](flux)>=totehTresh[12]['C'][0], dtype = prec)
toteh_M_metrics_decoders[12] = lambda flux : tf.cast(totehDecoders[12](flux)>=totehTresh[12]['M'][0], dtype = prec)
toteh_X_metrics_decoders[12] = lambda flux : tf.cast(totehDecoders[12](flux)>=totehTresh[12]['X'][0], dtype = prec)
...
toteh_C_metrics_decoders[24] = lambda flux : tf.cast(totehDecoders[24](flux)>=totehTresh[24]['C'][0], dtype = prec)
toteh_M_metrics_decoders[24] = lambda flux : tf.cast(totehDecoders[24](flux)>=totehTresh[24]['M'][0], dtype = prec)
toteh_X_metrics_decoders[24] = lambda flux : tf.cast(totehDecoders[24](flux)>=totehTresh[24]['X'][0], dtype = prec)
...
toteh_C_metrics_decoders[36] = lambda flux : tf.cast(totehDecoders[36](flux)>=totehTresh[36]['C'][0], dtype = prec)
toteh_M_metrics_decoders[36] = lambda flux : tf.cast(totehDecoders[36](flux)>=totehTresh[36]['M'][0], dtype = prec)
toteh_X_metrics_decoders[36] = lambda flux : tf.cast(totehDecoders[36](flux)>=totehTresh[36]['X'][0], dtype = prec)
...
toteh_C_metrics_decoders[48] = lambda flux : tf.cast(totehDecoders[48](flux)>=totehTresh[48]['C'][0], dtype = prec)
toteh_M_metrics_decoders[48] = lambda flux : tf.cast(totehDecoders[48](flux)>=totehTresh[48]['M'][0], dtype = prec)
toteh_X_metrics_decoders[48] = lambda flux : tf.cast(totehDecoders[48](flux)>=totehTresh[48]['X'][0], dtype = prec)
...
toteh_C_metrics_decoders[72] = lambda flux : tf.cast(totehDecoders[72](flux)>=totehTresh[72]['C'][0], dtype = prec)
toteh_M_metrics_decoders[72] = lambda flux : tf.cast(totehDecoders[72](flux)>=totehTresh[72]['M'][0], dtype = prec)
toteh_X_metrics_decoders[72] = lambda flux : tf.cast(totehDecoders[72](flux)>=totehTresh[72]['X'][0], dtype = prec)
...
toteh_C_metrics_decoders[144] = lambda flux : tf.cast(totehDecoders[72](flux)>=totehTresh[144]['C'][0], dtype = prec)
toteh_M_metrics_decoders[144] = lambda flux : tf.cast(totehDecoders[72](flux)>=totehTresh[144]['M'][0], dtype = prec)
toteh_X_metrics_decoders[144] = lambda flux : tf.cast(totehDecoders[72](flux)>=totehTresh[144]['X'][0], dtype = prec)
